...
public class PGSQLScriptGen implements DatabasePulgginInterface {
    ...
    public PGSQLScriptGen() {
        dataTypes.put("rip_sql_short_string", "text");
        dataTypes.put("rip_sql_mediam_string", "text");
        dataTypes.put("rip_sql_long_string", "text");
        dataTypes.put("rip_sql_small_lnteger", "integer");
        dataTypes.put("rip_sql_mediam_integer", "integer");
        dataTypes.put("rip_sql_big_integer", "integer");
        dataTypes.put("rip_sql_float", "double precision");
        dataTypes.put("rip_sql_date_with_tz", "date");
        dataTypes.put("rip_sql_date_without_tz", "date");
        dataTypes.put("rip_sql_date", "date");
        dataTypes.put("rip_sql_time", "time with time zone");
        dataTypes.put("rip_sql_timestamp", "timestamp with time zone");
        dataTypes.put("rip_sql_small_blob", "bytea");
        dataTypes.put("rip_sql_mediam_blob", "bytea");
        dataTypes.put("rip_sql_large_blob", "bytea");
        dataTypes.put("rip_sql_xml", "xml");
        dataTypes.put("rip_sql_boolean", "boolean");
    ...
    public String createDDLScript(JSONObject platformIndependentModel) {
        ...
        String rip_sql_database_name = Database_Design.getString("rip_sql_database_name");
