 ...
 */
public class SQLServerScriptGen implements DatabasePulgginInterface {

    HashMap dataTypes = new HashMap();

    public SQLServerScriptGen() {
        ...
        dataTypes.put("rip_sql_mediam_integer", "int");
        dataTypes.put("rip_sql_big_integer", "bigint");
        dataTypes.put("rip_sql_float", "float");
        dataTypes.put("rip_sql_date_with_tz", "date");
        dataTypes.put("rip_sql_date_without_tz", "date");
        dataTypes.put("rip_sql_date", "date");
        dataTypes.put("rip_sql_time", "time(7)");
        dataTypes.put("rip_sql_timestamp", "timestamp");
        dataTypes.put("rip_sql_small_blob", "binary(50)");
        dataTypes.put("rip_sql_mediam_blob", "varbinary(50)");
        dataTypes.put("rip_sql_large_blob", "varbinary(50)");
        dataTypes.put("rip_sql_xml", "xml");
        dataTypes.put("rip_sql_boolean", "bit");
    ...
    public static void main(String[] args) {
        ...
        SQLServerScriptGen databaseobject = new SQLServerScriptGen();
